        ...
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="mb-6 text-gray-500">
                    ...
                    Ready to dive back into the world of wagging tails and purring cuddles? 🌟 
                    Let's get you reunited with your furry friend and all the wonderful pet-centric features awaiting you! 🐶 
                    Simply log in to access your personalized pet profile, schedule appointments effortlessly, and explore a world of pet care resources at your fingertips. 🐾 
                    Your pet can't wait to see you again, so let's make every moment together unforgettable! 🐾💖
                </p>
                <p class="font-bold">
