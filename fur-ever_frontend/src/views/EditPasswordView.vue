    ...
    <div class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <h1 class="mb-6 text-2xl">🔒 Time for a Pawsword Refresh!</h1>

                <p class="mb-6 text-gray-500">
                    Hey there, awesome pet parent! Ready to give your account a little extra security? Now's the perfect time to update your password and keep your Paw-rofile safe and sound. 🌟✨
                    <br>
                    <br>Let's make sure your furry friends' stories stay protected! 🐾🔐
                </p>
            </div>
        </div>
    ...
    methods: {
        submitForm() {
            ...
            if (this.form.password1 !== this.form.password2) {
                this.errors.push('Oops... The passwords does not match!')
            }
