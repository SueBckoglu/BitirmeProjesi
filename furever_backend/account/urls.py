...
urlpatterns = [
    ...
    path('pets/create/', api.create_pet, name='create_pet'),
    path('list-pet/', api.list_pet, name='list_pet'),
    path('shelter_profile/create/', api.create_shelter_profile, name='create_shelter_profile'),  # Added the missing URL pattern
    path('events/create/', api.create_event, name='create_event'),
]
